...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.extras_impulse2_0 = extras.impulse2(1024, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_throttle_0_0_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_throttle_0_0_0, 0), (self.qtgui_freq_sink_x_1_1, 0))
        self.connect((self.blocks_throttle_0_0_0, 0), (self.qtgui_time_sink_x_1_0_0, 0))
        self.connect((self.extras_impulse2_0, 0), (self.blocks_throttle_0_0_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_freq_sink_x_1_1_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 300000, 100, firdes.WIN_HAMMING, 6.76))
