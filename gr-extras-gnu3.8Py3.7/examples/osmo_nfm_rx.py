...
class osmo_nfm_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.limesdr_source_0.set_sample_rate(s_rate)
        ...
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_char*1, '127.0.0.1', 1234, 500, False)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_cc(gain_0)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/Users/dir/Desktop/atsc-tv/mpegOut.ts', False)
    ...
    def set_gain_0(self, gain_0):
        self.gain_0 = gain_0
        self.blocks_multiply_const_vxx_0.set_k(self.gain_0)
