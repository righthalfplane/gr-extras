...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_freq_sink_x_1_1_0 = qtgui.freq_sink_c(
            nfft, #size
        ...
        self.qtgui_freq_sink_x_1_1_0.set_y_label('Relative Gain', 'dB')
        ...
        self.qtgui_freq_sink_x_1_1_0.enable_grid(False)
        self.qtgui_freq_sink_x_1_1_0.set_fft_average(1.0)
        ...
        self._qtgui_freq_sink_x_1_1_0_win = sip.wrapinstance(self.qtgui_freq_sink_x_1_1_0.pyqwidget(), Qt.QWidget)
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_1_1_0_win)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_1_1_win)
        self.extras_impulse_1 = extras.impulse(1024, 0)
        self.blocks_vector_to_stream_0_0_0_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, nfft)
        self.blocks_vector_to_stream_0_0_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, nfft)
        self.blocks_throttle_0_0_0 = blocks.throttle(gr.sizeof_gr_complex*nfft, samp_rate,True)
        ...
        # Connections
        ##################################################
        self.connect((self.band_reject_filter_0, 0), (self.qtgui_freq_sink_x_1_1_0, 0))
        self.connect((self.blocks_throttle_0_0_0, 0), (self.blocks_vector_to_stream_0_0_0, 0))
        self.connect((self.blocks_throttle_0_0_0, 0), (self.blocks_vector_to_stream_0_0_0_0, 0))
        self.connect((self.blocks_vector_to_stream_0_0_0, 0), (self.qtgui_freq_sink_x_1_1, 0))
        self.connect((self.blocks_vector_to_stream_0_0_0, 0), (self.qtgui_time_sink_x_1_0_0, 0))
        self.connect((self.blocks_vector_to_stream_0_0_0_0, 0), (self.band_reject_filter_0, 0))
        self.connect((self.extras_impulse_1, 0), (self.blocks_throttle_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_reject_filter_0.set_taps(firdes.band_reject(1, self.samp_rate, 600000, 700000, 100, firdes.WIN_HAMMING, 6.76))
        self.blocks_throttle_0_0_0.set_sample_rate(self.samp_rate)
        self.qtgui_freq_sink_x_1_1.set_frequency_range(0, self.samp_rate)
        self.qtgui_freq_sink_x_1_1_0.set_frequency_range(0, self.samp_rate)
